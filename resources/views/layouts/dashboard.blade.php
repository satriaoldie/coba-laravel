  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
        <div class="sidebar-brand-text mx-3">Sistem Barang Belajar</div>
      </a>
      ...
      <li class="nav-item {{ (request()->is('master/*')) ? 'active' : '' }}">
        ...
        <div id="collapsePagesMaster" class="collapse nav-item {{ (request()->is('master/*')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item {{ (request()->is('master/kategori*')) ? 'active' : '' }}" href="{{ route('get.kategori') }}">Kategori</a>
            <a class="collapse-item {{ (request()->is('master/sub-kategori*')) ? 'active' : '' }}" href="{{ route('get.sub-kategori') }}">Sub Kategori</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Sulistia R 2022</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
