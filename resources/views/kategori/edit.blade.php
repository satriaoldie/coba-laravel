  ...
  <div class="card-body">
    ...
    <form action="{{ route('update.kategori', $kategori->id) }}" method="post">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control @error('nama_kategori_barang') is-invalid @enderror" name="nama_kategori_barang" value="{{ old('nama_kategori_barang', $kategori->nama_kategori_barang) }}">
